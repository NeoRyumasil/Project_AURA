/**
 * Desktop AvatarRenderer tests — mirrors dashboard/AvatarRenderer.test.jsx
 * All GPU / PIXI / Live2D dependencies are mocked so tests run in jsdom.
 */
...
const mockRenderer = { width: 400, height: 580 }
const mockApp = {
  stage:    mockStage,
...
describe('AvatarRenderer (desktop)', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
